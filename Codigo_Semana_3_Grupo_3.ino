...
long float ultimos_ticks_esq = 0;
long float ultimos_ticks_dir = 0;
...
void calcula_odometria() {
    ...
    float VarAng = (Deltra_rad_esq - Delta_rad_dir)/DIST_RODAS;

    float Vel_Ang_centro = (VarAng/DT);


//POR AGORA ERRADO
    //float Delta_X = DeslocLinear*cos(VarAng);

    //float Delta_Y = DeslocLinear*sen(VarAng);
}
